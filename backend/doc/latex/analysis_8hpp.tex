...
In order to add a new analysis metric and have it show up in the frontend, add a new function in this file, and call the function in \hyperlink{class_backend_a149d05a4861bc09a73908f9817666586}{Backend\+::analyze\+\_\+target}. Then, add a member to the \hyperlink{class_result}{Result} class to hold the result of the analysis metric, and modify \hyperlink{class_result_a60cc412b37005131a08b776e63755ded}{Result\+::serialize} so that it additionally outputs the member variable that you just added to the \hyperlink{class_result}{Result} class. You should also update the \hyperlink{class_result}{Result} constructor so that it accepts a new parameter for initializing the member variable that you just added. 
